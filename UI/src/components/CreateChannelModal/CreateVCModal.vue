      ...
      <div class="modal-body">
        ...
        <div class="modal-body__form-group">
          ...
          <p class="checkbox-description">
            Только участники с разрешением смогут присоединяться к данному каналу
          </p>
        </div>
      </div>
...
const addVoiceChannel = async () => {
  try {
    const response = await apiClient.post<VoiceChannel>(
      `/servers/${rout.params.id}/add/voicechannels`,
      channelData.value,
      {
        headers: {
